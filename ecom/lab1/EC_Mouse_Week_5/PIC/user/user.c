    ...
    if(USBGenRead((byte*)&dataPacket,sizeof(dataPacket)))
    {
        ...
        switch(dataPacket.CMD)
        {
            case 0:
                ...
                dataPacket._byte[2] = ReadWithSPIHalfDuplex(0x0d);
                counter=0x04;
                break;
			case 1:
				//WriteWithSPIHalfDuplex(0x0d, 0); //change resolution
...
void GetDeltaXY(void)
{
    ...
    if(USBGenRead((byte*)&dataPacket,sizeof(dataPacket)))
    {
        ...
        switch(dataPacket.CMD)
        {
            case 0:
                //dataPacket._byte[1] is len
                dataPacket._byte[2] = ReadWithSPIHalfDuplex(0x03);
				dataPacket._byte[3] = ReadWithSPIHalfDuplex(0x04);
                counter=0x04;
                break;
            default:
    ...
    if(USBGenRead((byte*)&dataPacket,sizeof(dataPacket)))
    {
        ...
        switch(dataPacket.CMD)
        {
            case 0:
                ...
                break;
			case 1:
				WriteWithSPIHalfDuplex(0x0b, 0);	//reset the graber
				counter=0x02;
				break;
            default:
                break;
